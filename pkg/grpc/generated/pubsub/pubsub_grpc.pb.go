...
const (
	PubSub_Subscribe_FullMethodName = "/pubsub_contract.PubSub/Subscribe"
	PubSub_Publish_FullMethodName   = "/pubsub_contract.PubSub/Publish"
)
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pubsub_contract.PubSub",
	...
	Metadata: "pkg/grpc/proto/pubsub.proto",
}
